  ...
  return (
    <footer className="bg-surface-900 text-surface-300 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 pb-12 border-b border-surface-700">
          {/* Brand */}
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-lg font-bold text-white">CodeGuard</span>
            </Link>
            <p className="mt-3 text-sm text-surface-400 leading-relaxed">
              AI-powered code review that enforces SOLID principles and best practices.
            </p>
          </div>
